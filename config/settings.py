...
class AppSettings:
    ...
    google_calendar_retry_count: int = 2
...
def load_settings() -> AppSettings:
    ...
    google_calendar_sync_enabled = _parse_bool(os.getenv("GOOGLE_CALENDAR_SYNC_ENABLED", "true"))
    google_calendar_retry_count = int(os.getenv("GOOGLE_CALENDAR_SYNC_RETRY_COUNT", "2"))
    ...
    return AppSettings(
        ...
        google_calendar_retry_count=google_calendar_retry_count,
